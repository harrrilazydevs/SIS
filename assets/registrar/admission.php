                ...
                <h6>Applicants List</h6>
                    <nav class="mt-3">
                        <div class="nav nav-tabs" id="nav-tab" role="tablist">
                            <a class="nav-link active" data-toggle="tab" href="#nav_application_status" role="tab">Freshmen</a>
                            <a class="nav-link" data-toggle="tab" href="#nav_profile" role="tab">Cross Enrollees</a>
                            <a class="nav-link" data-toggle="tab" href="#nav-contact" role="tab">Foreign Students</a>
                            <a class="nav-link" data-toggle="tab" href="#nav-contact" role="tab">Transferee</a>
                        </div>  
                    </nav>
                    <div class="tab-content border rounded tab_border py-0 px-0" id="nav-tabContent">

                    <!-- Application Status -->
                        <div class="tab-pane fade show active container-fluid tab_container" id="nav_application_status" role="tabpanel">

                            <div class="row ">

                                <div class="col-lg-10"></div>

                                <div class="col-lg-2 pt-4 text-right">

                                <div class="row">
                                <div class="col-3 pr-1"><button class="btn btn-sm border"><i class="fas fa-filter"></i></button></div>
