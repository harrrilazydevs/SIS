<div class="container-fluid px-lg-4 " id="page-building-maintenance">

    <div class="row mb-1">

        <div class="col-12 pt-lg-2 text-right px-0 d-block d-lg-none " style="font-size: 17pt;"> 
            
            <label ><b>Building Maintenance</b>
        ...
        <div class="col-12 pt-lg-4 pt-5 px-0 container-fluid" style="font-size: 12pt;"> 
            ...
            <div class="mt-1 row">
                ...
                <div class="col-6 pt-2 mt-1 text-right">
                    ...
                    <a data-toggle="modal" data-target="#md_admin_add_building" class="btn border btn-sm"><i class="far fa-plus-square"></i> New</a>
            ...
            <div class="row">
                ...
                <div class="col">
                    ...
                    <div class="table-responsive border-right border-left border-bottom rounded">
                        ...
                        <table class="table table-sm" id="tbl_buildings">
                                
                            <thead style="font-size: 10pt;" class="border-bottom">
                                
                                <tr>
                                    <th class="text-center  px-4" width="10%">#</th>
                                    <th class="text-center"  width="10%">Bldg No</th>
